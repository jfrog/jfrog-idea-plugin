...
public interface Events {
    ...
    Topic<Events> ON_SCAN_FILTER_LICENSES_CHANGE = Topic.create("Scan licenses changed", Events.class);
    Topic<Events> ON_SCAN_FILTER_ISSUES_CHANGE = Topic.create("Scan issues changed", Events.class);
